...
<Columns cols={3}>
  ...
  <Card title="Multiple methods" icon="credit-card">
    Accept PIX, direct card charges, and boletos.
  </Card>
  <Card title="PIX withdrawals" icon="money-bill-transfer">
    Move BRL balance out via PIX with daily limits and compliance checks.
  </Card>
  <Card title="Hosted checkout" icon="browser">
    Use YuvexPay's hosted checkout page or headless PIX and card flows.
  </Card>
